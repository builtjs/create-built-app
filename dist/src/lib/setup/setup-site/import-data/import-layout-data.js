...
exports.default = importLayoutData;
const create_layout_1 = __importDefault(require("../create-layout"));
const fileUtils = __importStar(require("../file-utils"));
async function importLayoutData(client, layout) {
    ...
    await (0, create_layout_1.default)(client, layout.data, files);
}
